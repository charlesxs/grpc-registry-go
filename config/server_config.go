...
type EtcdRegistryConfig struct {
	...
	Interval             int64    `mapstructure:"interval" json:"interval" yaml:"interval"`                                              // 注册中心配置, 指定多久检测并重新续约
	LeaseTTL             int64    `mapstructure:"lease_ttl" json:"lease_ttl" yaml:"lease_ttl"`                                           // 注册中心配置, 租约时长
}
